...
KAFKA_BOOTSTRAP = os.getenv("KAFKA_BOOTSTRAP_SERVERS", "broker-1:19092,broker-2:19092,broker-3:19092")
KAFKA_TOPIC = os.getenv("KAFKA_TOPIC", "reviews")

BRONZE_PATH = "s3a://kafka/bronze/" + KAFKA_TOPIC
SILVER_PATH = "s3a://kafka/silver/" + KAFKA_TOPIC
GOLD_PATH = "s3a://kafka/gold/" + KAFKA_TOPIC
BRONZE_CKPT = "s3a://kafka/_checkpoint_bronze/" + KAFKA_TOPIC
...
SPARK_EVENT_LOG_DIR = os.getenv("SPARK_EVENT_LOG_DIR", "s3a://spark/spark-events")
SPARK_HISTORY_LOG_DIR = os.getenv("SPARK_HISTORY_LOG_DIR", "s3a://spark/spark-events")